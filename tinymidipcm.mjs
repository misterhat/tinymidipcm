...
["_tsf_load_memory","_tsf_set_output","_tsf_channel_set_bank_preset","_tsf_reset","_tsf_close","_tml_load_memory","_midi_render","_malloc","_realloc","_free","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('tinymidipcm.wasm', import.meta.url).toString();
}
